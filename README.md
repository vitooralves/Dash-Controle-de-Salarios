...
Adiantamentos, IRPF, INSS e FGTS

Salário líquido a pagar

Tabela Analítica por Cargo e Departamento:

Supervisores, Operários, Pleno, Junior, Analistas e Seniors

Distribuição dos valores em Compras, Contabilidade, Estoque, Produção e RH

Filtros Dinâmicos:

Localizações: Curitiba, Rio de Janeiro, Santa Catarina, São Paulo

Cargos: Junior, Operário, Pleno, Senior, Supervisor

Departamentos: Compras, Contabilidade, Estoque, Produção
...
O RH aparece com menor participação (R$ 7,4 mil).
